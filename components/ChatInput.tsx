      ...
      >
        ...
        >
          <textarea
            ...
            rows={1}
            className="block w-full resize-none overflow-hidden bg-transparent text-base leading-[1.75rem] text-foreground placeholder:text-muted-foreground focus:outline-none"
          />
        </div>
      </div>
